...
// LastLoggedAt applies equality check predicate on the "last_logged_at" field. It's identical to LastLoggedAtEQ.
func LastLoggedAt(v time.Time) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLastLoggedAt, v))
}
...
// LastLoggedAtEQ applies the EQ predicate on the "last_logged_at" field.
func LastLoggedAtEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLastLoggedAt, v))
}

// LastLoggedAtNEQ applies the NEQ predicate on the "last_logged_at" field.
func LastLoggedAtNEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldLastLoggedAt, v))
}

// LastLoggedAtIn applies the In predicate on the "last_logged_at" field.
func LastLoggedAtIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldIn(FieldLastLoggedAt, vs...))
}

// LastLoggedAtNotIn applies the NotIn predicate on the "last_logged_at" field.
func LastLoggedAtNotIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldLastLoggedAt, vs...))
}

// LastLoggedAtGT applies the GT predicate on the "last_logged_at" field.
func LastLoggedAtGT(v time.Time) predicate.User {
	return predicate.User(sql.FieldGT(FieldLastLoggedAt, v))
}

// LastLoggedAtGTE applies the GTE predicate on the "last_logged_at" field.
func LastLoggedAtGTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldGTE(FieldLastLoggedAt, v))
}

// LastLoggedAtLT applies the LT predicate on the "last_logged_at" field.
func LastLoggedAtLT(v time.Time) predicate.User {
	return predicate.User(sql.FieldLT(FieldLastLoggedAt, v))
}

// LastLoggedAtLTE applies the LTE predicate on the "last_logged_at" field.
func LastLoggedAtLTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldLTE(FieldLastLoggedAt, v))
}
