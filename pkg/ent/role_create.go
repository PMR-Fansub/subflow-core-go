...
// SetDesc sets the "desc" field.
func (u *RoleUpsert) SetDesc(v string) *RoleUpsert {
	u.Set(role.FieldDesc, v)
	return u
}

// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *RoleUpsert) UpdateDesc() *RoleUpsert {
	u.SetExcluded(role.FieldDesc)
	return u
}
...
// SetDesc sets the "desc" field.
func (u *RoleUpsertOne) SetDesc(v string) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetDesc(v)
	})
}
...
// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateDesc() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateDesc()
	})
}
...
// SetDesc sets the "desc" field.
func (u *RoleUpsertBulk) SetDesc(v string) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetDesc(v)
	})
}
...
// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateDesc() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateDesc()
	})
}
