...
func (uc *UserCreate) SetLastLoggedAt(t time.Time) *UserCreate {
	uc.mutation.SetLastLoggedAt(t)
	return uc
}

// SetNillableLastLoggedAt sets the "last_logged_at" field if the given value is not nil.
func (uc *UserCreate) SetNillableLastLoggedAt(t *time.Time) *UserCreate {
	if t != nil {
		uc.SetLastLoggedAt(*t)
	}
	return uc
}

// SetLoginIP sets the "login_ip" field.
func (uc *UserCreate) SetLoginIP(s string) *UserCreate {
	uc.mutation.SetLoginIP(s)
	return uc
}

// SetNillableLoginIP sets the "login_ip" field if the given value is not nil.
func (uc *UserCreate) SetNillableLoginIP(s *string) *UserCreate {
	if s != nil {
		uc.SetLoginIP(*s)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.LastLoggedAt(); !ok {
		v := user.DefaultLastLoggedAt
		uc.mutation.SetLastLoggedAt(v)
	}
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.LastLoggedAt(); !ok {
		return &ValidationError{Name: "last_logged_at", err: errors.New(`ent: missing required field "User.last_logged_at"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.LastLoggedAt(); ok {
		_spec.SetField(user.FieldLastLoggedAt, field.TypeTime, value)
		_node.LastLoggedAt = value
	}
	if value, ok := uc.mutation.LoginIP(); ok {
...
// SetRegisteredAt sets the "registered_at" field.
func (u *UserUpsert) SetRegisteredAt(v time.Time) *UserUpsert {
	u.Set(user.FieldRegisteredAt, v)
	return u
}

// UpdateRegisteredAt sets the "registered_at" field to the value that was provided on create.
func (u *UserUpsert) UpdateRegisteredAt() *UserUpsert {
	u.SetExcluded(user.FieldRegisteredAt)
	return u
}
...
// SetLastLoggedAt sets the "last_logged_at" field.
func (u *UserUpsert) SetLastLoggedAt(v time.Time) *UserUpsert {
	u.Set(user.FieldLastLoggedAt, v)
	return u
}

// UpdateLastLoggedAt sets the "last_logged_at" field to the value that was provided on create.
func (u *UserUpsert) UpdateLastLoggedAt() *UserUpsert {
	u.SetExcluded(user.FieldLastLoggedAt)
	return u
}

// SetLoginIP sets the "login_ip" field.
func (u *UserUpsert) SetLoginIP(v string) *UserUpsert {
	u.Set(user.FieldLoginIP, v)
	return u
}

// UpdateLoginIP sets the "login_ip" field to the value that was provided on create.
func (u *UserUpsert) UpdateLoginIP() *UserUpsert {
	u.SetExcluded(user.FieldLoginIP)
	return u
}

// ClearLoginIP clears the value of the "login_ip" field.
func (u *UserUpsert) ClearLoginIP() *UserUpsert {
	u.SetNull(user.FieldLoginIP)
	return u
}
...
// SetRegisteredAt sets the "registered_at" field.
func (u *UserUpsertOne) SetRegisteredAt(v time.Time) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetRegisteredAt(v)
	})
}
...
// UpdateRegisteredAt sets the "registered_at" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateRegisteredAt() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
...
// SetLastLoggedAt sets the "last_logged_at" field.
func (u *UserUpsertOne) SetLastLoggedAt(v time.Time) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetLastLoggedAt(v)
	})
}
...
// UpdateLastLoggedAt sets the "last_logged_at" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateLastLoggedAt() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateLastLoggedAt()
	})
}

// SetLoginIP sets the "login_ip" field.
func (u *UserUpsertOne) SetLoginIP(v string) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetLoginIP(v)
	})
}
...
// UpdateLoginIP sets the "login_ip" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateLoginIP() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateLoginIP()
	})
}
...
// ClearLoginIP clears the value of the "login_ip" field.
func (u *UserUpsertOne) ClearLoginIP() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearLoginIP()
	})
}
...
// SetRegisteredAt sets the "registered_at" field.
func (u *UserUpsertBulk) SetRegisteredAt(v time.Time) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetRegisteredAt(v)
	})
}
...
// UpdateRegisteredAt sets the "registered_at" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateRegisteredAt() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateRegisteredAt()
	})
}
...
// SetLastLoggedAt sets the "last_logged_at" field.
func (u *UserUpsertBulk) SetLastLoggedAt(v time.Time) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetLastLoggedAt(v)
	})
}
...
// UpdateLastLoggedAt sets the "last_logged_at" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateLastLoggedAt() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateLastLoggedAt()
	})
}
...
// SetLoginIP sets the "login_ip" field.
func (u *UserUpsertBulk) SetLoginIP(v string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetLoginIP(v)
	})
}
...
// UpdateLoginIP sets the "login_ip" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateLoginIP() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateLoginIP()
	})
}
...
// ClearLoginIP clears the value of the "login_ip" field.
func (u *UserUpsertBulk) ClearLoginIP() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearLoginIP()
	})
}
